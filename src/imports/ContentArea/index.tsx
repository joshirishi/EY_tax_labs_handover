import svgPaths from "./svg-1dplfat9j5";
  ...
  return (
    <div className="relative shrink-0 size-[8px]" data-name="circle">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
        <g clipPath="url(#clip0_8_242)" id="circle">
          <path d={svgPaths.p3c2c1c00} id="Vector" stroke="var(--stroke-0, #FFE600)" strokeLinecap="round" strokeWidth="2" />
        </g>
        <defs>
...
export default function ContentArea() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[48px] items-start pb-[80px] relative size-full" data-name="Content Area">
      <Frame64 />
      <Frame3 />
      <Frame62 />
    </div>
